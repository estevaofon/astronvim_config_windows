...
function M.setup(opts)
  ...
  if not M.current.api_key then M.current.api_key = vim.env.ANTHROPIC_API_KEY or vim.env.CLAUDE_API_KEY end
...
-- Set API key
function M.set_api_key(key) M.current.api_key = key end
